...
for i, matrix in enumerate(matrices):
    ...
    for face in faces:
        ...
        pl.add_mesh(tmesh, smooth_shading=True, color="orange", diffuse=2, ambient=0.5, specular=15)
    pl.set_focus((0, 0, 0))
    pl.set_position((2.5, 2.5, 2.5))
    pl.camera.model_transform_matrix = matrix
    pngname = "zpic%03d.png" % i
    pl.show(screenshot=pngname)

os.system(
    "magick convert -dispose previous -loop 0 -delay 8 zpic*.png BarthHyperbolicpolyhedron.gif"    
)
